	...
	<div id="container">
		...
		<div id="write">
			<a href="BoardWriteForm.jsp" style="text-decoration: none;">글쓰기</a>
					...
					<table>태그에 .table-hover 클래스를 추가하면 테이블에 마우스를 올렸을 때의 반환</table>
					<table>태그에 .table-bordered 선택자를 추가하면 셀에 테두리 생성</table>
					<table>태그에 .table-stripe 선택자를 추가하면 한 줄 건너 배경색 달라지는 스트라이프</table>
